...
public class Logging {
    ...
    @Pointcut("@annotation(SpringBootMVCREST.aop.annotation.MET)")
    public void loggableMethod() {
    }

    @Pointcut("@annotation(SpringBootMVCREST.aop.annotation.MyDeprecated)")
